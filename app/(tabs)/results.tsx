              ...
              <View style={styles.viewerBottomBar}>
                <View style={styles.viewerInfo}>
                  <Text style={styles.viewerInfoText}>
                    {formatMB(viewerItem.asset.fileSize)} ·{" "}
                    {viewerItem.asset.width}×{viewerItem.asset.height}
                  </Text>
                ...
                <View style={styles.viewerActions}>
                  ...
                  <Pressable
                    ...
                    style={[
                      ...
                      state.selectedIds.has(viewerItem.asset.id) &&
                        styles.viewerSelectBtnActive,
                    ]}
                  >
                    <MaterialIcons
                      name={
